...
} from '../../../traceability-model/infrastructure/parsers/work-item-frontmatter-parser.ts';
import {
  WorkItemFrontmatterValidationError,
} from '../../../traceability-model/domain/value-objects/work-item-frontmatter.ts';
...
---`;
      ...
      // Act & Assert
      expect(() => parseWorkItemFrontmatter(content)).toThrow(
        WorkItemFrontmatterValidationError,
      );
    });
  });
