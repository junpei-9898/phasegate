...
@work-item-id WI-159
@story-id H10-02
設計要素: Phase Gate self-hosting 用の quick-mode Unit definition.
...
- 2026-05-13: `@unit quick-mode` を解決する Phase Gate self-hosting entry を追加した。
- 2026-07-16: WI-285 で WI-159 / H10-02 traceability を含む詳細定義を canonical path へ統合し、単一正本化した。
