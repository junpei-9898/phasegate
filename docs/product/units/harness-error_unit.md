...
@story-id H06-01
@work-item-id WI-156
設計要素: Phase Gate self-hosting 用の harness-error Unit definition.
...
- 2026-05-13: Phase Gate self-hosting の kebab-case path 解決用 entry を追加した。
- 2026-07-16: WI-285 で詳細定義と WI-156 traceability annotation を canonical path へ統合し、単一正本化した。
