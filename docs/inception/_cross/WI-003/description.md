...
- **状態**: 🟢 **CLOSED (v0.86.0, 2026-04-23)** — 159 → 0 件完全解消。Wave 1〜5 (v0.75.0〜v0.80.0) + 派生 ISSUE-015/016/017/018/019/020/022 経由で完遂。最終 8 件の presentation→domain は ISSUE-019 / ADR-014 (Robert C. Martin 版 CA 準拠) で許容化
- **起票日**: 2026-04-06
