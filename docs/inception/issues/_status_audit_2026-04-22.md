...
| ISSUE-014 Wave 1 | **着手 (v0.92.0, 2026-04-23)**: ADR-015 起票 + `wave1_schema_proposal.md` で preset 6 種の schema / 層行列 / マイグレーション戦略を確定。実装コード変更なし、設計文書のみ。Wave 2 以降で `LayerName` config 注入 → schema v3 実装 → dogfood → ガイド追記（推定 4d） |
