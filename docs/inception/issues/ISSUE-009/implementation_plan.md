...
> **⚠️ 2026-04-23: DEFERRED** — 本計画は Orchestration Engine（`docs/product/orchestration_product_overview.md`）の session-manager / `.session.lock` / worktree 契約と責務境界が重複することが判明し、保留中。詳細は [issue_description.md](./issue_description.md#保留判断2026-04-23) の「保留判断」セクション参照。再開時は v2.0 として orchestration 委譲部分（L1 ref-counted freeze / P2 flock / P3 sync debounce / P4 stale ref cleanup）を削除し、~3d に圧縮して再提示する。

**参照元**: [ISSUE-009 issue_description.md](./issue_description.md)
**起票日**: 2026-04-22
