...
- **状態**: 🟡 **IN PROGRESS**（Wave 3 完了 / 2026-04-23）
  ...
  - Wave 4 以降: `flat` preset 実装 + 残存 tag 扱い + preset/user 優先度 → `onion / hexagonal / layered / strict-ddd / custom` 実装 + dogfood 検証 → ガイド追記（各 Wave の詳細は wave1_schema_proposal.md §4 参照）
- **優先度**: P2
- **起票日**: 2026-04-23
