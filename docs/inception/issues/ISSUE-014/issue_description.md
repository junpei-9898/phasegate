...
- **状態**: 🟡 **IN PROGRESS**（Wave 4 完了 / 2026-04-23）
  ...
  - Wave 5 以降: `no-layer-violation` への architecture.allowedDependencies 注入 + `onion / hexagonal / layered / strict-ddd / custom` dogfood 検証 → ガイド追記（各 Wave の詳細は wave1_schema_proposal.md §4 参照）
- **優先度**: P2
- **起票日**: 2026-04-23
...
| Wave 5 | Phase D + E | `no-layer-violation` への architecture 注入 + `onion / hexagonal / layered / strict-ddd / custom` dogfood 検証 | 1d |
